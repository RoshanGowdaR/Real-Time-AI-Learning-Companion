      ...
      <div className="relative w-96 max-w-full bg-[#111118] rounded-2xl p-10 shadow-[0_30px_80px_rgba(0,0,0,0.6)] border border-[#1e1e2e]">
        ...
        <div className="relative my-6">
          <div className="absolute inset-0 flex items-center">
            <span className="w-full border-t border-[#1e1e2e]"></span>
          </div>
          <div className="relative flex justify-center text-xs">
            <span className="bg-[#111118] px-2 text-gray-500 uppercase">Or continue with</span>
          </div>
        </div>
        ...
        <button
          ...
          disabled={loading}
          className="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-100 text-gray-900 font-medium rounded-xl py-3 transition-all duration-200 cursor-pointer disabled:opacity-70"
        >
